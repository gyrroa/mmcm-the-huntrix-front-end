        ...
        >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 mb-10">
                {property.images.map((src, i) => (
                    ...
                    >
                        <Image src={src} alt={`${property.name} image ${i + 1}`} fill className="object-cover" />
                    </motion.div>
                ))}
            </div>
            ...
            {property.description && (
                <div className="bg-white rounded-xl p-6 shadow mb-10">
                    ...
                    <p className="text-sm text-[#5C7188] leading-relaxed tracking-wide">{property.description}</p>
                </div>
            )}
            ...
            {/* 🔸 Reviews (Renters only) */}
            <ReviewSection slug={property.slug} isRent={isRent} propertyName={property.name} />
