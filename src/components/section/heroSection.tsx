...
const HeroSection: React.FC = () => {
    return (
        <section id="heroSection" className="text-[#002353] grid grid-cols-2 pt-[184px] pl-[160px] bg-gradient-to-b from-[#D2E4FF] to-[#D2E4FF]/0 min-h-screen h-[1040px] w-full mt-[-96px]">
            ...
            <div className="relative h-full flex flex-col gap-[32px]">
                ...
                <div className="absolute flex flex-col bg-white rounded-[8px] p-6 w-fit gap-6">
                    <div className="flex gap-[16px]">
                        <div className="w-[64px] h-[64px] rounded-full bg-[green]" />
