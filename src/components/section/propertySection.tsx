...
const PropertySection: React.FC = () => {
    ...
    return (
        ...
        >
            <section ref={propertySectionRef} id="propertySection" className="text-[#002353] flex flex-col pt-[80px] px-[160px] pb-[100px] gap-[64px] bg-gradient-to-b from-white to-[#D2E4FF] min-h-dvh w-full text-center items-center">
                {/* Title */}
