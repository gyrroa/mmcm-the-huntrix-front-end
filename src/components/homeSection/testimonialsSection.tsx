      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-12 xl:px-14 py-12 md:py-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-start">
          ...
          <div className="flex flex-col gap-4 md:gap-6 text-start">
            ...
            {/* Controls (show on all sizes; spaced better on mobile) */}
            <div className="flex mt-4 md:mt-6 gap-6 justify-center md:justify-start">
              <button
                type="button"
                onClick={prev}
                aria-label="Previous testimonial"
                className="hover:scale-105 transition-all duration-150 cursor-pointer p-1 md:p-0"
              >
                <Image
            ...
            {/* Mobile dots */}
            <div className="flex items-center justify-center gap-2 mt-4 lg:hidden" role="tablist" aria-label="Testimonial pagination">
          ...
          <div className="relative flex items-center">
            ...
            <motion.div
              ...
              className="bg-white shadow-[10px_10px_30px_0_rgba(0,0,0,0.10)] rounded-2xl md:rounded-[30px] p-5 sm:p-6 md:p-8 lg:p-10 w-full max-w-xl md:max-w-[500px] flex flex-col gap-5 sm:gap-6 md:gap-8 z-10"
            >
              <Image
        ...
        {/* CTA banner */}
        <div className="relative mt-12 md:mt-16 bg-[#003175] w-full rounded-2xl md:rounded-[40px] flex flex-col lg:flex-row items-center justify-between pt-0 p-6 md:p-0 gap-6 overflow-visible md:pl-8 md:pr-10 lg:pr-28">
          {/* deco — hide on small */}
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="101"
          ...
          {/* Illustration (stacked on top on mobile) */}
